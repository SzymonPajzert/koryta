...
def extract(ctx: Context):
    for blob_name, content in ctx.io.read_data(CloudStorage(prefix="hostname=jawnylublin.pl")).read_iterable():
        ...
        # koryta-pl-crawled/hostname=jawnylublin.pl/date=2025-09-19/afera-pkol-cba-szuka-w-lubelskim-dowodow-w-sledztwie-dotyczacym-radoslawa-piesiewicza
        ...
        # you can see the running HTML easily by clicking "Authenticated URL" on the page to see the blob in the browser.
        ...
        if "afera-pkol-cba-szuka-w-lubelskim-dowodow" in blob_name:
            ...
            # The next time you'll run this script, the data will be fetched from the local storage.

        # We'd like to iterate some of the high quality pages to find their evidence of corruption.
