...
class NLPImpl(NLP):
    ...
    def lemmatize(self, text_data: Union[str, List[str]]) -> Union[str, List[str]]:
        """
        Lemmatizes input text using spaCy. Allowed data types: string and list of strings.
        Automatically routes the request to single or batch processing based on input type.
        """
