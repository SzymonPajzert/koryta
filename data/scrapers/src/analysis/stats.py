...
class Statistics(Pipeline):
    ...
    def process(self, ctx: Context):
        ...
        combination_counts_series = df[PEOPLE_COLUMNS_TO_CHECK].notnull().groupby(PEOPLE_COLUMNS_TO_CHECK).size()
        combination_counts_series = combination_counts_series.sort_values(ascending=False)
