...
export const QA_ITEMS: QaItem[] = [
  {
    ...
    steps: [
      ...
      "Odśwież stronę: wypełniony przycisk ma zostać wypełniony, a bilans obok niego ma się zgadzać - nie wracać do stanu sprzed Twojego głosu. To jest ten krok, który wcześniej nie działał: strona osoby jest cache'owana na 6 godzin także dla zalogowanych, więc sekcja dopytuje o same liczniki osobnym, niecache'owanym zapytaniem.",
