  ...
  return {
    clusters: [
      ...
      base({
        ...
        crew: [
          {
            personId: "p-pawel-milek",
            personName: "Paweł Miłek",
            companies: 4,
            parties: [],
          },
        ],
        hires: [
          hire("Dariusz Grajda", "POLSKIE KOLEJE PAŃSTWOWE", "2024-05-09", [
            "PSL",
          ]),
          hire("Marzena Piszczek", "PKP CARGO (Warszawa)", "2024-11-29", [
            "PO",
          ]),
        ],
        score: 4.01,
