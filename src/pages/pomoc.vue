<template>
  ...
  <v-row cols="12">
    ...
    <v-col cols="12">
      <h2 class="text-h5 font-weight-bold">
        Przejrzyj te artykuły - zgłoszone przez Ciebie pojawią się po lewej
        stronie
      </h2>
    </v-col>
  ...
  <v-col cols="12" md="6">
    <v-virtual-scroll :height="400" :items="articlesAssigned">
  ...
  <v-col cols="12" md="6">
    <v-virtual-scroll :height="400" :items="articlesUnssigned">
      <template v-slot:default="{ item: article }">
        <ArticleCard :article="article[1]" :articleID="article[0]" />
      </template>
    </v-virtual-scroll>
